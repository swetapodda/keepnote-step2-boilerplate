...
public class NoteController {
	...
	public String getAllNotes(ModelMap map) {
		...
		map.addAttribute("notesList", noteDAO.getAllNotes());
		return "index";
	}
	/*
	...
	public String add(@ModelAttribute("note") Note note, ModelMap modelMap) {
		...
		modelMap.addAttribute("notesList", noteDAO.getAllNotes());
		return redirectUrl;
	...
	public String updateNote(@ModelAttribute("note") Note note, ModelMap modelMap) {
		String redirectUrl = "index";
		if (null != note) {
